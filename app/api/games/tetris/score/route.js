// app/api/games/tetris/score/route.js  ->  POST /api/games/tetris/score
//
...
export async function POST(request) {
  ...
  const playSession = await redis.getdel(`tetris:session:${token}`);
  ...
  if (account) {
    ...
    const beforeRank = await redis.zrevrank("tetris:leaderboard", id);
